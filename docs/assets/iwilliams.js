...
;define("iwilliams/components/app-window/template", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  ...
  /*
    <div 
      class="app-window absolute border-2 border-gray-400 border-outset bg-red-100 
          {{if (eq this.windowManager.currentlyDragging this) "z-10"}}"
      {{did-insert this.didInsert}}
      {{will-destroy this.willDestroy}}
  >
      <div 
          class="app-window__title p-2 {{if this.isDragging "cursor-grabbing" "cursor-grab"}}"
  ...
  */
  {
    "id": "l9JdxILg",
    "block": "[[[11,0],[16,0,[29,[\"app-window absolute border-2 border-gray-400 border-outset bg-red-100 \\n        \",[52,[28,[37,1],[[30,0,[\"windowManager\",\"currentlyDragging\"]],[30,0]],null],\"z-10\"]]]],[4,[38,2],[[30,0,[\"didInsert\"]]],null],[4,[38,3],[[30,0,[\"willDestroy\"]]],null],[12],[1,\"\\n    \"],[11,0],[16,0,[29,[\"app-window__title p-2 \",[52,[30,0,[\"isDragging\"]],\"cursor-grabbing\",\"cursor-grab\"]]]],[4,[38,4],[\"mousedown\",[30,0,[\"mouseDown\"]]],null],[12],[1,\"\\n        \"],[1,[30,1]],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,0],[15,0,[29,[\"app-window__body \",[52,[30,0,[\"resizable\"]],\"overflow-scroll resize min-w-fit\"]]]],[12],[1,\"\\n        \"],[18,2,null],[1,\"\\n    \"],[13],[1,\"\\n\"],[13]],[\"@title\",\"&default\"],false,[\"if\",\"eq\",\"did-insert\",\"will-destroy\",\"on\",\"yield\"]]",
...
;define("iwilliams/templates/application", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  ...
  <AppWindow 
      @title="About Me"
  >
      <p>Hello! My name is Ian Williams, but I usually just go by <i>iwilliams</i> on the internet.</p>
  </AppWindow>
...
;
          if (!runningTests) {
            require("iwilliams/app")["default"].create({"name":"iwilliams","version":"0.0.0+1c70bf09"});
          }
